...
def visualize_first_element(data_loader):
	...
	for batch, targets, masks in data_loader:
		...
		print_batch_targets_stats(batch, targets)
		print("First element in batch:", batch[0])
		print("First element's mask:", masks_X[0])
		print("Length of sequences in batch:", masks_X.sum(axis=1))
		print()
		print("First element's target:", targets[0])
		print("First element's target's mask:", masks_Y[0])
		print("Length of target sequences in batch:", masks_Y.sum(axis=1))
		return
